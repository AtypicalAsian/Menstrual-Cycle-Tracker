...
*/
const calculateNextPeriod = (lastPeriod, cycleLength) => {
...
*/
const calculatePregnancyTestDay = (lastPeriod) => {
...
*/
const calculateExpectedDueDate = (lastPeriod) => {
...
function calculateOutcomes(lastPeriod, cycleLength) {
